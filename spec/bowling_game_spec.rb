...
describe "BowlingGame" do
  describe ".rolls=" do
    before { BowlingGame.rolls = [] }
    it { expect(BowlingGame.instance_variable_get(:@rolls)).to eql([])}
    it { expect(BowlingGame.instance_variable_get(:@frame)).to eql(1)}
    it { expect(BowlingGame.instance_variable_get(:@total)).to eql(0)}
    it { expect(BowlingGame.instance_variable_get(:@scores_of_frames)).to eql({})}
  end
